...
def write_results(ppl: float, model: str, dataset: str, wq_bits: int, wq_datatype: str, wq_groupsize: int):
    BASE_PATH = "/home/yc2367/llm/test_llm_eval_c4_wikitext/results_llm"
    if wq_groupsize <= 0:
        wq_groupsize = "none"
